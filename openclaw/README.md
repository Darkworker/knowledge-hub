...
### 1. TechNickAI/openclaw-config 配置项目（2026.3.23）
**社区优秀配置分享**：
...
### 2. OpenClaw 2026.3.8 备份功能更新（2026.3.10）
**新增 CLI 备份命令**：
...
### 3. CVE-2026-31995 命令注入漏洞披露（2026.3.20）
**重要安全公告**：
- **类型**：命令注入漏洞（CWE-78）
...
### 4. OpenClaw 2026.3.13 修复版发布（2026.3.14）
**重要修复版本**：
- 修复了 v2026.3.13 发布路径中的问题
- Git 标签使用 `v2026.3.13-1`，npm 版本仍为 `2026.3.13`
- 解决了不可变发布无法重用标签的问题

### 5. OpenClaw 2026.3.7 - ContextEngine 革命性更新（2026.3.9）
...
### 6. MCP (Model Context Protocol) 原生支持（2026.3月）
...
**安全提醒**：鉴于近期发现的多项严重安全漏洞（包括 CVE-2026-31995 命令注入、CVE-2026-31998 授权绕过等），强烈建议所有用户立即升级至最新版本（2026.3.13+）并遵循安全部署最佳实践。
...
| 日期 | 版本 | 主要内容 |
|------|------|----------|
| 2026-03-24 | - | **专题更新**：新增 TechNickAI/openclaw-config 项目、Mac 睡眠问题解决方案、浏览器 Relay 扩展指南、GCP 部署建议 |
| 2026-03-23 | - | 新增 CLI 备份功能、CVE-2026-31995/31998/31999 等漏洞披露、GitHub Stars 突破30万 |
